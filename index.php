...
<head>
    ...
    <title>Pecom – Centro de Control Profesional</title>
    ...
    <style>
        /* Botón de salir simple; si querés lo llevamos a styles.css */
        .btn-logout {
            padding: 6px 12px;
            border-radius: 999px;
            background: #ef4444;
...
<body>
    ...
    <div id="view-fleet" class="view">
        ...
        <header class="header">
            ...
            <div style="display:flex; align-items:center; gap:10px; font-size:11px; color:var(--text-sec);">
                <span>
                    Supervisor: <strong><?php echo htmlspecialchars($_SESSION['user'] ?? 'Admin'); ?></strong>
                </span>
            ...
            <div class="col-right">
                ...
                <div class="row-bottom">
                    <div class="panel half">
                        <div class="panel-title" style="flex-direction:column; align-items:flex-start;">
                            <span>Litros Entregados (Mensual)</span>
                            <span style="font-size:11px; font-weight:400; color:var(--primary); margin-top:2px;">Total periodo: <strong id="totalEntregado">0 L (6 meses)</strong></span>
                        </div>
    ...
    <div class="modal-overlay" id="modalForm" style="z-index: 2001;">
        <div class="form-content">
            ...
            <div class="form-group">
                <label for="formProduct">Producto Químico</label>
...
<!-- MODAL GESTIÓN DE PATINES -->
<div id="modalForm" class="modal">
    <div class="modal-content">
        <h2 id="form-title">Gestión de Patín</h2>

        <label>ID (código visible)</label>
        <input id="form-id" type="text" placeholder="001" />

        <label>Zona</label>
        <input id="form-zona" type="text" placeholder="Mendoza Norte" />

        <label>Producto</label>
        <input id="form-prod" type="text" placeholder="Antiincrustante A" />

        <label>Sensor</label>
        <input id="form-sensor" type="text" placeholder="SEN-001" />

        <label>Capacidad (L)</label>
        <input id="form-cap" type="number" placeholder="400" />

        <label>Nivel actual (L)</label>
        <input id="form-litros" type="number" placeholder="250" />

        <label>Latitud</label>
        <input id="form-lat" type="number" step="0.0001" />

        <label>Longitud</label>
        <input id="form-lng" type="number" step="0.0001" />

        <div class="modal-actions">
            <button onclick="guardarPatin()" class="btn btn-primary">Guardar</button>
            <button onclick="eliminarPatin()" class="btn btn-danger">Eliminar</button>
            <button onclick="cerrarFormulario()" class="btn btn-secondary">Cancelar</button>
        </div>
    </div>
</div>
